...
const Bottom9 = () => {
    const product = [{
        ...
        price: "₹ 79,900",
        des: "(Teal,128GB)",
        name: "Apple iphone 16 Plus (Teal,128GB)"
    }, {
        id: 2,
        src: "https://img-prd-pim.poorvika.com/cdn-cgi/image/width=131,height=131,quality=75/product/Apple-lightning-to-usb-cable-1m-white-mxly2zm-a-01.png",
        price: "₹ 67,900",
        des: "(Marble Grey, 8GB-256B)",
        name: "Samsung Galaxy S24 5G(Marble..."
    }, {
        id: 3,
        src: "https://img-prd-pim.poorvika.com/cdn-cgi/image/width=131,height=131,quality=75/product/Apple-Airpods-2-True-Wireless-White-01.png",
        price: "₹ 26,900",
        des: "(Cleadon Grey, 8GB-256B)",
        name: "One Plus Nord CE4 5G (Cleadon M..."
    }, {
        id: 4,
        src: "https://img-prd-pim.poorvika.com/cdn-cgi/image/width=131,height=131,quality=75/product/Apple-USB-Power-Adapter-20W.png",
        price: "₹ 25,900",
        des: "(2a) Plus 5g",
    ...
    return (
        <>
            <div className="md:mx-20 mt-3 pt-6 mx-0 bg-white">
                <div>
                    <img src='https://img-prd-pim.poorvika.com/cdn-cgi/image/width=1900,height=400,quality=75/pageimg/Premium-Smart-Phone-Acc3.png' />
                </div>
                <div className='h-fit'>
                    <div className='flex  justify-between border p-1 bg-slate-100 mx-1 mt-3 px-14 pt-2'>
                        <div className=' font-bold text-2xl text-orange-500'>iPhone & Accessories Galore</div>
            ...
            <div className="md:mx-20 mt-3 pt-8 pb-3 mx-0 bg-white">
                <img src='https://img-prd-pim.poorvika.com/cdn-cgi/image/width=1900,height=200,quality=75/pageimg/apple-banner.png' />
            </div>
        </>
    )
}
